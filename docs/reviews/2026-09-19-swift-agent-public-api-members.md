...
All 1,316 currently public symbols are `KEEP`. Compared with `1.0.0-rc.1`,
the exact precise-identifier diff is 360 additions and 0 removals. The 138
...
[AgentUsage annex](2026-09-19-sai-069-public-api-additions.md), and the 21
SAI-071 additions are enumerated in the
[Local Responses annex](2026-09-20-sai-071-public-api-additions.md). The table below
contains the pre-AgentUsage, pre-Local-Responses non-Decision inventory after the RC.2 remediation.
...
| AgentProviders | 41 | 122 | +81 |
| AgentTools | 311 | 311 | +0 |
| AgentUsage | 0 | 139 | +139 |
| WorkspaceAgent | 56 | 56 | +0 |
| **Total** | **956** | **1316** | **+360** |

Top-level public types: **138** current, **100** in rc.1.
